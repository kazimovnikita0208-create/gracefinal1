// Скрипт для настройки webhook с новым токеном
const https = require('https');

const botToken = '7725254943:AAGHFlrj2oDfLxjrNaWjYuJ_nhUlgr2qLZU';
const webhookUrl = 'https://gracefinal-kub3x79wz-nikitas-projects-1742d776.vercel.app/api/simple-webhook';

console.log('🔧 Настраиваем webhook с новым токеном...');
console.log('🤖 Новый токен бота:', botToken);
